...
const { addressesTotal } = require("@blockfrost/blockfrost-js/lib/endpoints/api/addresses");
const app = express();

app.use("/", require("./blockfrost.routers"));

require("../server/blockfrost.routers")(app);
