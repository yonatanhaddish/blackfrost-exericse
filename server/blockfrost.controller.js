...
const getScriptUtxo = async (req, params) => {
    ...
    try {
        ...
        const scriptAddress = "addr_test1qqdtqvzkl3fd0vrtjy3z40a700s8j0q0q5g9dcucdwmwk5nwy6f7gh2vzugvl7cwyhp5nsmrp4qj7ypf9wku3kc9e2hszrn7n5"
        // const api_url = `https://cardano-testnet.blockfrost.io/api/v0/addresses/${address_02}/total`
        // const api_url = "https://cardano-testnet.blockfrost.io/api/v0/txs/027034b65dc469983761ed071aca90beda2f6a4abebabac80cfdd419161298da/utxos"
        const api_url = `https://cardano-testnet.blockfrost.io/api/v0/addresses/${scriptAddress}/utxos`
